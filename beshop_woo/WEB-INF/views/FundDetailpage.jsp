				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
						    <div class="product-fund-cday">3일 남음</div>
							...
							<div class="product-fundper">
								<strong>2756</strong> %달성	
							</div>
                            <div class="product-fund-totalprice">
                                <strong>57.539.000</strong> 원 달성
                            </div>
							<div>
							...
							<div class="add-to-cart">
								...
								<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> 펀딩하기</button>
