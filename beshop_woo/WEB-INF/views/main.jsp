...
<div class="jquery-script-clear"></div>
   ...
   <ul class="poster-list"> 
    <li class="poster-item" ><div class="use-play-1 flowplayer" data-player-id="56058953-2cbd-4858-a915-1253bf7ef7b2">
       <script src="//cdn.flowplayer.com/players/8dfd6c14-ba3a-445e-8ef5-191d9358ed0a/native/flowplayer.async.js">
    { "src": "video/chungha.mp4,
      "logo": "img/beShop.png" }
 	 </script>
        </div></li> 
						...
						<div class="products-widget-slick" data-nav="#slick-nav-5">
							...
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">이어폰/헤드폰</p>
										<h3 class="product-name"><a href="#">Britz 브리츠인터내셔널 W800BT</a></h3>
