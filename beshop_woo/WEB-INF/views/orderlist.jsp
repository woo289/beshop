...
<!DOCTYPE html>
   <html>
    ...
    <script>
          ...
          $(function(){
        	  $.ajax({ url:"orderListSet",success:function(data){
      			alert(data);
      			console.log(data);
      			$.each(data,function(i,s){
      				var tr = $("<tr></tr>");
      				var name = $("<td></td>").html(s.pname);
      				var price = $("<td></td>").html(s.p_price+"원");
      				//var data = $("<td></td>").html(s.odate);
      				
      				var bprice = $("<td>무료</td>");
      				var dstatus = $("<td></td>").html(s.dstatus);
      				$(tr).append(name,price,bprice,dstatus);
